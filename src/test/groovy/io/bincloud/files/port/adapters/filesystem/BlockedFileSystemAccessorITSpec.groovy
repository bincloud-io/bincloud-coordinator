package io.bincloud.files.port.adapters.filesystem
...
import io.bincloud.files.port.adapter.file.filesystem.FilesystemStreamDestination
import io.bincloud.files.port.adapter.file.filesystem.FilesystemStreamSource
