...
import io.bincloud.files.domain.model.contracts.download.Fragment
import io.bincloud.files.domain.model.contracts.download.Range
import io.bincloud.files.domain.model.contracts.download.DownloadListener.DownloadProcessType
import io.bincloud.files.domain.model.contracts.download.FileDownloader.DownloadRequestDetails
import io.bincloud.files.domain.model.contracts.download.FileDownloader.FileDownloadRequest
