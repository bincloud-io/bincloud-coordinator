...
import io.bcs.files.domain.model.contracts.download.DownloadListener
import io.bcs.files.domain.model.contracts.download.FileDownloader
import io.bcs.files.domain.model.contracts.download.Fragment
import io.bcs.files.domain.model.contracts.download.Range
import io.bcs.files.domain.model.contracts.download.DownloadListener.DownloadProcessType
import io.bcs.files.domain.model.contracts.download.FileDownloader.DownloadRequestDetails
import io.bcs.files.domain.model.contracts.download.FileDownloader.FileDownloadRequest
