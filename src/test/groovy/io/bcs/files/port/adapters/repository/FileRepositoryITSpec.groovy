...
import io.bcs.files.domain.model.states.CreatedState
import io.bcs.files.domain.model.states.DisposedState
import io.bcs.files.domain.model.states.DistributionState
import io.bcs.files.domain.model.states.DraftState
import io.bcs.files.port.adapter.file.repository.JPAFileRepository
import io.bcs.files.port.adapter.file.repository.JPAFileStateConverter
