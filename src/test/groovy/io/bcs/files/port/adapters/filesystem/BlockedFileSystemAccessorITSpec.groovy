package io.bcs.files.port.adapters.filesystem
...
import io.bcs.files.port.adapter.file.filesystem.FilesystemStreamDestination
import io.bcs.files.port.adapter.file.filesystem.FilesystemStreamSource
