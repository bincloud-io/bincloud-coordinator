...
class DefaultValidationContextSpec extends Specification {
	...
	def "Scenario: append error messages into context"() {
		...
		TextTemplate[] ungroupedErrorTextTemplates = (TextTemplate[])[MESSAGE_TEMPLATE_1, MESSAGE_TEMPLATE_2, MESSAGE_TEMPLATE_3]

		and: "The grouped error messages text templates"
		TextTemplate[] groupedErrorTextTemplates = (TextTemplate[])[MESSAGE_TEMPLATE_1, MESSAGE_TEMPLATE_2]
		...
		errorState.getUngroupedErrors().containsAll([MESSAGE_TEMPLATE_1, MESSAGE_TEMPLATE_2, MESSAGE_TEMPLATE_3]) == true

		and: "The error state should contain error messages appended to the ${FIRST_LEVEL_GROUP_NAME} group"
		GroupedErrors.errorsOf(FIRST_LEVEL_GROUP_NAME, errorState).containsAll([MESSAGE_TEMPLATE_1, MESSAGE_TEMPLATE_2])
	}
	...
	def "Scenario: validate internal validatable subobjects"() {
		...
		errorState.getUngroupedErrors().containsAll([MESSAGE_TEMPLATE_1, MESSAGE_TEMPLATE_8])
		GroupedErrors.errorsOf(FIRST_LEVEL_GROUP_NAME, errorState).containsAll([MESSAGE_TEMPLATE_2, MESSAGE_TEMPLATE_3])
		GroupedErrors.errorsOf(DERIVED_FROM_FIRST_AND_SECOND_LEVEL_GROUP_NAME, errorState).containsAll([MESSAGE_TEMPLATE_4, MESSAGE_TEMPLATE_5])
		GroupedErrors.errorsOf(DERIVED_FROM_FIRST_AND_SECOND_AND_THIRD_LEVEL_GROUP_NAME, errorState).containsAll([MESSAGE_TEMPLATE_6, MESSAGE_TEMPLATE_7])
	}
