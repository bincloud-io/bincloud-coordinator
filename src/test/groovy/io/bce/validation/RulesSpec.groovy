...
class RulesSpec extends Specification {
	...
	def "Scenario: failed rules checks"() {
		...
		new RuleExecutor(Optional.empty(), {Rules.isPresent(FAIL_MESSAGE_TEMPLATE)})                              | [FAIL_MESSAGE_TEMPLATE.withParameter(VALIDATED_ELEMENT_PARAMETER_NAME, Optional.empty())]
		new RuleExecutor(Optional.of(SIMPLE_OBJECT), {Rules.isMissing(FAIL_MESSAGE_TEMPLATE)})                    | [FAIL_MESSAGE_TEMPLATE.withParameter(VALIDATED_ELEMENT_PARAMETER_NAME, Optional.of(SIMPLE_OBJECT))]
