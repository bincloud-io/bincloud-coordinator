...
public class FileFragments {
    ...
    private static class FileFragment implements ContentFragment {
        ...
        private Long normalizeStartPosition(Optional<Long> startOfRange, Optional<Long> endOfRange, Long fileSize) {
            ...
            return startOfRange.orElseGet(() -> {
                log.trace(
                        "The start of range is missing. The start range is tried to be calcilated as: fileSize - endOfRange");
        ...
        private Long normalizeEndPosition(Optional<Long> startOfRange, Optional<Long> endOfRange, Long fileSize) {
            log.debug(TextTemplates
