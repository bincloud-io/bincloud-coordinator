...
public interface TextTemplate {
	...
	/**
	 * Check equivalence with another object. It is important if two objects are
	 * equal, their {@link TextTemplate#hashCode()} results should be equal(by convention)
	 * and {@link TextTemplate#toString()} results should be equal and have equal hash codes.
	 * 
	...
	/**
	 * Compile template and return result according to chosen interpolation
	 * algorithm which the template string implementation applies for interpolation
	 * 
