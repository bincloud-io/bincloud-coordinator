...
/**
 * This class represents the validation group name value and it is responsible
 * for manipulations with this. You should wrap your string values by this type
 * so this class . The validation group name length must not exceed 1000 characters.
 * 
...
final class ValidationGroup {
	...
	public static final class WrongValidationGroupFormatException extends RuntimeException {
		...
		public WrongValidationGroupFormatException(String groupName) {
			super(String.format("The validation group name \"%s\" isn't matched to the \"%s\" pattern.", groupName,
					GROUP_NAME_PATTERN));
		}
	}
}
