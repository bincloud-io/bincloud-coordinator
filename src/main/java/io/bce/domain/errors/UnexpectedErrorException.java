...
public class UnexpectedErrorException extends ApplicationException {	
	...
	public UnexpectedErrorException(@NonNull BoundedContextId contextId, @NonNull Throwable unexpectedError) {
