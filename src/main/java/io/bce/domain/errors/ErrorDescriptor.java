...
/**
 * This interface describes an abstraction which provides data about happened
 * error
 * 
...
public interface ErrorDescriptor {
	...
	public enum ErrorSeverity {
		/**
		 * The incident error severity. It shows that the error happened because of an
		 * internal error and it is not expected error.
		 */
		INCIDENT,
		/**
		 * The business error severity. It shows that the error happened because of
		 * incorrect input parameters and it is expected error.
		 */
		BUSINESS;
	}

	/**
	 * This class represents the special error code. It should be 
	 * used everywhere, when the value has the error code into 
	 * a bounded context semantic and not a random number value.
	 * It will prevent the situation when the error code will be 
	 * confused with another number value having another semantic
	 * and will used for math calculations for example.
	 * 
	 * @author Dmitry Mikhaylenko
	 *
	 */
	...
	public class ErrorCode implements Wrapped<Long> {
